...
let celebrationSoundEnabled = localStorage.getItem("celebrationSoundEnabled") === "true";
...
function playCelebrationSound() {
  ...
  try {
    ...
    notes.forEach((freq, index) => {
      ...
      gain.gain.exponentialRampToValueAtTime(0.18, ctx.currentTime + index * 0.11 + 0.02);
      gain.gain.exponentialRampToValueAtTime(0.0001, ctx.currentTime + index * 0.11 + 0.18);
      osc.connect(gain);
