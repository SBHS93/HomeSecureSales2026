...
// Local 3-second quick impact celebration sound. Upload the sounds folder to your site root.
const CELEBRATION_SOUND_URL = "./sounds/sale-impact.wav";
...
function playCelebrationSound() {
  ...
  try {
    ...
    celebrationAudio.play().then(() => {
      ...
      console.warn("Celebration MP3/WAV did not play. Check that /sounds/sale-impact.wav is uploaded, or click the page once first:", err);
