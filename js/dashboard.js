...
// Local 5-second loud applause celebration sound. Upload the sounds folder to your site root.
const CELEBRATION_SOUND_URL = "./sounds/sale-celebration.mp3";
const celebrationAudio = new Audio(CELEBRATION_SOUND_URL);
...
function playCelebrationSound() {
  ...
  try {
    ...
    celebrationAudio.play().then(() => {
      ...
      console.warn("Celebration MP3/WAV did not play. Check that /sounds/sale-celebration.mp3 is uploaded, or click the page once first:", err);
